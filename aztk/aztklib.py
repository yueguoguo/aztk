    ...
    def __init__(self):
        ...
        self.client = aztk_sdk.spark.Client(
            aztk_sdk.spark.models.SecretsConfiguration(
                ...
                batch_resource_url=secrets_config.batch_resource_url,
                ...
                service_principal_tenant_id=secrets_config.service_principal_tenant_id,
                service_principal_client_id=secrets_config.service_principal_client_id,
                service_principal_credential=secrets_config.service_principal_credential,
